  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-full p-8 text-center bg-card">
      ...
      <div className="mb-8 relative">
        ...
        <div className="relative w-24 h-24 bg-primary text-primary-foreground rounded-full flex items-center justify-center shadow-2xl">
      ...
      <div className="w-full space-y-3">
        <div className="grid grid-cols-2 gap-3 mb-3">
          <Button
            variant="outline"
            className="h-14 rounded-2xl border-border text-foreground gap-2 font-bold"
          >
